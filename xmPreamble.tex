...
\newcommand{\blank}[1][2.5cm]{\underline{\hspace{#1}}}
\newcommand{\showwork}{\textbf{REMEMBER TO SHOW AND EXPLAIN YOUR WORK.}}
\newcommand{\showworkline}{\textbf{REMEMBER TO SHOW AND EXPLAIN YOUR WORK.
  Explanation should include how and why you know which line of the
  schedule was used to calculate this amount.}}
\newcommand{\showworkyear}{\begin{sloppypar}\textbf{REMEMBER TO SHOW AND
...
\newcommand{\schedhead}[1]{\begin{center}\textbf{#1}\end{center}}

\newcommand{\samesquares}[3][1]{%
\begin{center}
